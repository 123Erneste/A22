...
jer_intg errorNumber;				/* Run-time error number = 0 by default (ANSI) */

/* External objects */
extern jer_intg line; /* Source code line numbers - defined in scanner.c */
extern Token tokenizer(jer_nul);
